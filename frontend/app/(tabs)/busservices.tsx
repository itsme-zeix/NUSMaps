...
const NUS_SHUTTLE_ROUTES: { [key: string]: string[] } = {
  ...
  BTC: ["OTH", "BG-MRT", "KR-MRT", "LT27", "UHALL", "UHC-OPP", "UTOWN", "RAFFLES", "KV", "MUSEUM", "YIH", "CLB", "LT13", "AS5", "BIZ2", "PGP", "CG", "OTH"],
    ...
    <View style={{ flex: 1, backgroundColor: "white" }}>
      <View style={styles.mapContainer}>
        <MapView style={styles.map} region={routeSelected == "BTC" ? NUS_BTC : routeSelected == "L" ? BUKITTIMAHCAMPUS : NUS} rotateEnabled={false}>
          ...
          {MARKERDIRECTIONS[routeSelected] != undefined &&
            MARKERDIRECTIONS[routeSelected].map((directionMarker, index) => (
              <Marker
                key={index}
                coordinate={{
